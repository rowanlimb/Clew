...
#usermod -u $USER_ID $MONITOR_USER

#Create MySQL option files for MONITOR_USER and shiny users
cat > /tmp/my.cnf <<EOF && cp /tmp/my.cnf /home/${MONITOR_USER}/.my.cnf && chown $MONITOR_USER /home/${MONITOR_USER}/.my.cnf && cp /tmp/my.cnf /home/shiny/.my.cnf && chown shiny /home/shiny/.my.cnf && rm /tmp/my.cnf
[mysqladmin]
user=${DB_USER}
password=${DB_PASS}
